...
export const statesWithNbaTeams: Record<string, StateInfo> = {
...
export const nbaStatesCodes: string[] = Object.keys(statesWithNbaTeams);

// States that have other basketball teams (WNBA, NCAA, G-League) but no NBA
export const nonNbaBasketballStates: string[] = [
