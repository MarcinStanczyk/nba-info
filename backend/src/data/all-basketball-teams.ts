...
export const wnbaTeams: BasketballTeam[] = [
...
export const ncaaTeams: BasketballTeam[] = [
  // Alabama
...
export const gLeagueTeams: BasketballTeam[] = [
...
export function getAllTeamsForState(stateCode: string): BasketballTeam[] {
...
export const leagueConfig: Record<LeagueType, { color: string; bg: string; border: string; label: string }> = {
