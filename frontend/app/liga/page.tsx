...
const fallbackOverview: LeagueOverviewResponse = {
  nbaChampion: {
    season: "2024-2025",
    teamName: "Data unavailable",
    teamId: "unknown",
    badge: "",
    conference: "East",
  },
...
async function getLeagueOverview(): Promise<LeagueOverviewResponse> {
  try {
    return await backendFetch<LeagueOverviewResponse>("/api/standings");
  } catch {
