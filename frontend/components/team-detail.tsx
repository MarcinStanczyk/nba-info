...
import type { StandingEntry, StateInfo, EspnPlayer, DanceTeamInfo } from "@/lib/backend-types";
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <div className="flex flex-col gap-2">
                  {otherTeamsInState.map((other) => (
                    <Link key={other.id} href={`/team?id=${other.id}`} className="flex items-center gap-3 rounded-lg p-2 transition-colors hover:bg-secondary/50">
