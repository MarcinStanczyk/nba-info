...
import { nbaChampion, eastStandings, westStandings } from "@/backend/src/data/nba-standings";
import { standingsService } from "@/backend/src/standings/standings.service";

const stateChampions = standingsService.getStateChampions();
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <div className="mx-auto max-w-7xl px-4 py-6">
          {/* Champion Banner */}
          <ChampionBanner champion={nbaChampion} />
